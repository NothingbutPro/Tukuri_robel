...
public class My_order_detail_adapter extends RecyclerView.Adapter<My_order_detail_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, tv_price, tv_qty, tv_unitval,tv_order_del_type;
        ...
        public MyViewHolder(View view) {
            ...
            tv_order_del_type = (TextView) view.findViewById(R.id.tv_order_del_type);
        }
    }
    ...
    public void onBindViewHolder(My_order_detail_adapter.MyViewHolder holder, int position) {
        ...
        Glide.with(context)
               ...
               // .centerCrop()
                .placeholder(R.drawable.smart_repair_logo)
                .crossFade()
...
//        if(mList.getDelivery_status().equals("1")) {
//            holder.tv_order_del_type.setText("Pickup From Location");
//        }else {
//            holder.tv_order_del_type.setText("Home Delivery");
//        }
    }
