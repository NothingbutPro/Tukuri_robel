...
//        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(getActivity()).inflate(R.layout.cancel_order_dialog, null, false);
        builder.setView(dialogView);
        ImageView can_dialog = dialogView.findViewById(R.id.can_dialog);
        final EditText  edt_res = dialogView.findViewById(R.id.edt_res);
        Button buttonOk = dialogView.findViewById(R.id.buttonOk);
        can_dialog.setOnClickListener(new Add_delivery_address_fragment());
        ...
        buttonOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!edt_res.getText().toString().isEmpty()) {
                    alertDialog.dismiss();
                    makeReasonReqOrderRequest(sale_id , edt_res.getText().toString());
                }else {
                    Toast.makeText(getActivity(), "Please fill reason for canceling of order", Toast.LENGTH_SHORT).show();
                    edt_res.requestFocus();
                }
            }
        });
        alertDialog.show();
...
//        alertDialog.show();
    ...
    private void makeReasonReqOrderRequest(final String sale_id, String reason) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.SUBMIT_REASON, params, new Response.Listener<JSONObject>() {
